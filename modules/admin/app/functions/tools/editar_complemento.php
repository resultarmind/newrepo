...
if ($resultPanelId->num_rows > 0) {
    ...
    if (isset($_GET["id"])) {
        ...
        $sql = "SELECT * FROM complementos WHERE panel_id = $panel_id AND id = $complemento_id";
  ...
  <body>
    ...
    <div class="br-mainpanel">
      ...
      <div class="br-pagebody">
        ...
        <form action="atualizar_complemento.php" method="post" class="mt-4">
    <!-- Adicione os campos do formulário com os valores atuais da complemento -->
    <input type="hidden" name="id" value="<?php echo $produto['id']; ?>">

    <div class="form-group">
        <label for="nome_complemento">Nome da complemento:</label>
