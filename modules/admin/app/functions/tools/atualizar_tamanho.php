...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["id"]) && isset($_POST["nome_tamanho"])) {
        $tamanho_id = $_POST["id"];
        $nome_tamanho = $_POST["nome_tamanho"];
        ...
        if ($resultPanelId->num_rows > 0) {
            ...
            $sqlCheckOwnership = "SELECT id FROM tamanhos WHERE panel_id = $panel_id AND id = $tamanho_id";
            ...
            if ($resultCheckOwnership->num_rows > 0) {
                ...
                $sqlUpdate = "UPDATE tamanhos SET nome_tamanho = '$nome_tamanho' WHERE id = $tamanho_id";
                ...
                echo "Você não tem permissão para editar este tamanho.";
            }
        } else {
