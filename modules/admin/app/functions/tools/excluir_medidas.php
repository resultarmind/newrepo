...
if (isset($_GET['id'])) {
    ...
    if ($resultPanelId->num_rows > 0) {
        ...
        $sqlCheckOwnership = "SELECT id FROM medidas WHERE panel_id = $panel_id AND id = $complementoId";
        ...
        if ($resultCheckOwnership->num_rows > 0) {
            ...
            $sqlDelete = "DELETE FROM medidas WHERE id = $complementoId";
            ...
            echo "Você não tem permissão para excluir esta medida.";
        }
    } else {
