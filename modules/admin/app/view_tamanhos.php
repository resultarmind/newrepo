...
if ($resultPanelId->num_rows > 0) {
    ...
    $sqlProdutos = "SELECT * FROM tamanhos WHERE panel_id = '$panel_id'";
...
while ($produto = $resultProdutos->fetch_assoc()) {
    echo "<tr>";
    echo "<td>" . $produto["nome_tamanho"] . "</td>";
    ...
    // Link para editar
    echo '<a href="functions/tools/editar_tamanhos.php?id=' . $produto["id"] . '" class="btn btn-primary btn-sm">Editar</a>';
...
function confirmDelete(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'functions/tools/excluir_tamanhos.php?id=' + id;
        }
    });
}
</script>
